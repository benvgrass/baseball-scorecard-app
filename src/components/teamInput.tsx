    ...
    return (
        <form>
            <div className="relative h-full sm:shadow-md rounded-lg p-6 border-0 ring-1 ring-inset ring-gray-300">
                ...
                <div className="relative flex mt-1.5 rounded-md sm:shadow-md ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    <label
