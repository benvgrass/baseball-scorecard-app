...
export default function LineupCard({lineup, setLineup, startingPitcher, setStartingPitcher}: {
    ...
    return (
        <>
            ...
            <div
                className="relative sm:shadow-md px-4 sm:px-6 lg:px-8 -mx-4 mt-10 ring-1 ring-gray-300 sm:mx-0 rounded-sm sm:rounded-lg">
                <label
                    htmlFor="lineup"
                ...
                <table id="lineup" className="min-w-full divide-y divide-gray-300">
                    ...
                    <tr>
                        <th scope="col"
                            className="pb-0.5 pt-3.5 pl-4 pr-3 text-left text-sm font-medium text-gray-900 sm:pl-6">Batters
                        </th>
                        <th scope="col"
                            className="pb-0.5 pt-3.5 pl-4 pr-3 text-left text-sm font-medium text-gray-900 sm:pl-6">Position
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                    {lineup.map((player, i) => (
                        <tr key={player.battingOrder}>
                            <td className={classNames(
                                ...
                                <div
                                    className="group flex rounded-md sm:shadow-sm ring-1 ring-inset ring-gray-200 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <span
                                        className="inline-flex items-center rounded-l-md border-0 bg-gray-200 group-focus-within:bg-indigo-600 group-focus-within:text-white px-3 font-semibold  text-gray-700 sm:text-sm">
                                        {player.battingOrder + '.'}
                                    </span>
                                    <input
                                        type="text"
                                    ...
                                    {({open}) => (
                                        <>
                                            <div className="flex space-x-2.5 divide-y-2 divide-x mx-2">
                                                <Listbox.Button
                                                    className="group focus-within:font-semibold relative w-full cursor-default rounded-md bg-white py-1.5 pl-1 sm:pl-2 text-left text-gray-900 sm:shadow-sm ring-1 ring-inset ring-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-600 text-sm leading-6">
                                                    <span className="block">{player.position || '--'}</span>
                                                    <span
                                                        className="flex pointer-events-none absolute inset-y-0 right-0 pr-0.5 sm:pr-1 items-center">
                                                            <ChevronUpDownIcon
                                                                className="h-5 w-5 text-gray-700 group-focus-within:text-indigo-600"
                                                                aria-hidden="true"/>
                                                    </span>
                                                </Listbox.Button>
                                                <Transition
                                                ...
                                                >
                                                    <Listbox.Options
                                                        className="absolute z-10 mt-1 max-h-60 overflow-auto rounded-md bg-white py-1 sm:shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm sm:leading-6">
            ...
            <div
                className="relative px-4 sm:shadow-md sm:px-6 lg:px-8 py-4 -mx-4 mt-10 ring-1 ring-gray-300 sm:mx-0 rounded-sm sm:rounded-lg">
                <label
                    htmlFor="pitcher"
                    className="absolute -top-3.5 sm:left-2 inline-block bg-white px-1 text-md font-medium text-gray-900"
                >
